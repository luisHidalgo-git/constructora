...
class TVAuthService {
  ...
  static Future<bool> authenticateTVSession(String sessionId, String userToken) async {
    try {
  ...
  static Future<Map<String, dynamic>?> checkTVSessionStatus(String sessionId) async {
    try {
      final sessionData = await _getTVSession(sessionId);
